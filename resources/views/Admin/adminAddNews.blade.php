            ...
            <form class="" action="{{route('admin::news::saveNews')}}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="category" aria-label="category">
                        <option selected>{{\App\Http\Models\NewsCategories::find($model->category_id)->title ?? 'Нажмите для выбора'}}</option>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="source" value="{{\App\Http\Models\Source::find($model->source_id)->title ?? ''}}" placeholder="">
                </div>
